...
- If the user asks to stop talking or to turn talk mode off/on, or to change any claudeTalk setting (voice, speed, silence, sensitivity, hotkey, Enter, wake word, speak only to spoken messages, screen share, glass, position, language), use the claudeTalk talk skill.
"@
    if ($spoken) {
